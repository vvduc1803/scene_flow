...
def add_config(parser):
    ...
    parser.add_argument('--num_points', type=int, default=1024, help='Point number [default: 2048].')
    ...
    parser.add_argument('--dataset', type=str, default='KITTISceneFlowDataset',
                        ...
                        help='Dataset to use.')
    parser.add_argument('--dataset_path', type=str, default='./data/kitti', metavar='N',
                        help='Dataset path.')
    parser.add_argument('--compute_metrics', action='store_true', default=True, help='whether compute metrics or not.')
    parser.add_argument('--visualize', action='store_true', default=True, help='Show visuals.')
    ...
    parser.add_argument('--hidden_units', type=int, default=64, metavar='N', help='Number of hidden units in neural prior')
    parser.add_argument('--layer_size', type=int, default=4, metavar='N', help='Number of layers in neural prior')
